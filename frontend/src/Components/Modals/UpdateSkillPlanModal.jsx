...
const UpdateSkillPlanModal = () => {
  ...
  useEffect(() => {
    if (snap.selectedSkillPlanToUpdate) {
      const plan = snap.selectedSkillPlanToUpdate;
      setSkillDetails(plan.skillDetails);
      setSkillLevel(plan.skillLevel);
      setResources(plan.resources);
      setDate(plan.date);
      setIsFinished(plan.isFinished || plan.finished);
    }
  }, [snap.selectedSkillPlanToUpdate]);
  ...
  const handleUpdate = async () => {
    try {
      ...
      await SkillPlanService.updateSkillPlan(snap.selectedSkillPlanToUpdate.id, updatedPlan);
  ...
  if (!snap.updateSkillPlanOpened) return null;
    ...
    >
      ...
      >
        <div className="flex items-center justify-between p-4 border-b">
          <h2 className="text-xl font-bold text-gray-800">Update Skill Plan</h2>
          <button
            onClick={() => state.updateSkillPlanOpened = false}
        ...
        <div className="p-4 space-y-4">
          <div>
            ...
            <textarea
              ...
              placeholder="Update skill details..."
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Update your resources..."
            />
          </div>
